...
//Initialize views from the layout
        ...
        val handler = Handler()
        var delayMillis = 40L // Update snake position every 100 milliseconds
...
// to check collision between snake and meat
...
// check for meat collision and update ui
                    checkFoodCollision()
...
// set click listener to direction buttons
